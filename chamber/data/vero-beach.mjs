// data/vero-beach-attractions.mjs
export const attractions = [
    ...
    },
    {
        ...
        address: "Downtown Vero Beach (Humiston Park)",
        description: "Every Saturday: local produce, crafts, live music, and community spirit.",
        image: "images/farmers-market.webp",
        alt: "Vero Beach Farmers Market"
    },
    {
        name: "Round Island Oceanside Park",
        address: "2200 A1A South, Vero Beach, FL 32963",
        description: "Beautiful beach access, manatee viewing, and kayak launch.",
        image: "images/round-island.webp",
        alt: "Round Island Park beach"
    },
    {
